...
type PlantingsListScreenNavigationProp = NativeStackNavigationProp<
  RootStackParamList,
  'PlantingsList'
>;
  ...
  const renderItem = ({ item }: { item: Planting }) => (
    <View style={styles.card}>
      ...
      <View style={styles.actionButtons}>
        ...
        <TouchableOpacity style={styles.iconButton} onPress={() => handleDelete(String(item.id))}>
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptySubtext}>
              Toque no botão + para adicionar o seu primeiro plantio.
            </Text>
          </View>
        }
        refreshing={loading}
